        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        params = { id_type: MWSInfo.item_type, ids: MWSInfo.item_ids };
                        if (!MWSInfo.marketplace) {
                            params = lodash_1.default.assign(params, { marketplace: 'amazon.com' });
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        params = { id_type: MWSInfo.item_type, ids: MWSInfo.item_ids };
                        if (!MWSInfo.marketplace) {
                            params = lodash_1.default.assign(params, { marketplace: 'ATVPDKIKX0DER' });
                        }
